            ...
            <div class="myform form login-form">
              <span class="form-title"> LOGIN </span>
               ...
               ?>
                  ...
                  <div class="form-group">
                     <input type="password" name="password"  class="form-control my-input" id="email" placeholder="passord" required>
                  </div>
            
                  <div class="text-center ">
                     <button type="submit" class=" btn btn-block send-button tx-tfm" name="login_user">Login</button>
                  </div>
                  <div class="col-md-12 ">
                     <div class="login-or">
                        <hr class="hr-or">
                  ...
                  <p>Login As Owner form  <a href="login-owner.php">here</a></p>
