    ...
    <div class="row">
         <div class="col-md-4 mx-auto">
            <div class="myform form login-form">
              <span class="form-title"> sing up </span>
               <form action="" method="post" name="singUp">
                  <div class="form-group">
                     <input type="text" name="fname"  class="form-control my-input" id="name" placeholder="First name " required>
                  </div>
                  <div class="form-group">
                     <input type="text" name="lname"  class="form-control my-input" id="email" placeholder="last name"required>
                  </div>
                  <div class="form-group">
                     <input type="text" name="username"  class="form-control my-input" id="email" placeholder="Username">
                  </div>
                        <div class="form-group">
                     <input type="email" name="email"  class="form-control my-input" id="email" placeholder=" Email">
                  </div>
                  <div class="form-group">
                     <input type="password" name="password"  class="form-control my-input" id="email" placeholder="password">
                  </div>
                  <div class="form-group">
                     <input type="text" name="phone"  class="form-control my-input" id="email" placeholder="phone">
                  </div>
            ...
            <div class="form-group">
                  ...
                  <div class="text-center ">
                     <button type="submit"name ="singUp" class=" btn btn-block send-button tx-tfm">Sing Up</button>
                  </div>
                  <div class="col-md-12 ">
                     <div class="login-or">
                        <hr class="hr-or">
