    ...
    <div class="row">
         <div class="col-md-4 mx-auto">
            <div class="myform form login-form">
              <span class="form-title p-b-20"> Add a new owner </span>
               <form  action="" method="post" name="singUp">
                  ...
                  <div class="form-group">
                     <input type="text" name="lname"  class="form-control my-input"  placeholder="last name"required>
                  </div>
                  <div class="form-group">
                     <input type="text" name="username"  class="form-control my-input" placeholder="Username">
                  </div>
                  ...
                  <div class="form-group">
                     <input type="text" name="phone"  class="form-control my-input"  placeholder="phone number">
                  </div>
                      
                  <div class="text-center ">
                     <button type="submit"name ="add-user" class=" btn btn-block send-button tx-tfm">Add</button>
                  </div>
               </form>
            </div>
         </div>
