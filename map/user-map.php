...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
 ...
 <div class="container">
  ...
  <div class = "row bzumap ">
        ...
        <center><h1>Map of Birziet town</h1>

            <p><strong>NOTE : </strong>You can locate your residance by clicking on its place in the map below, where it will be reviewed by the administrator</p></center>
   <div id="map"></div>
    <script>
        /**
         * Create new map
        ...
        var myOptions = {
            zoom: 15,
            center: new google.maps.LatLng(31.959398, 35.181972),
            mapTypeId: 'roadmap'
        };
        ...
        function saveData(lat,lng) {
            ...
            var url = 'locations_model.php?add_location&markerId='+markerId+'description=' + description + '&lat=' + lat + '&lng=' + lng;
