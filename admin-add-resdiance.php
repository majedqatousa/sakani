...
<head>
  ...
  <title>Admin-add-resdiance</title>
            ...
            <div class="myform form login-form">
              <span class="form-title p-b-20"> Add a new resdiance </span>
               <form  action="" method="post" name="">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                     <input type="text" name="population"  class="form-control my-input"  placeholder="population"required>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <select class="form-control" name="owner_id">
                       ...
                       <?php 
                        $sql = "SELECT username from owners";
              ...
              <div class="form-check" id="numOfRooms" style="display:none;" >
               ...
               <div class="form-check m-b-10" id="avalableRooms"  style="display:none;">
                 <label class="m-t-5">Number Of avalabel Rooms :</label><br>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                    <select class="form-control" name="location_area">
                       <option value="0">--SELECT LOCATION AREA --</option>
              ...
              <div class="form-group">
                  ...
                  <div class="text-center ">
                     <button type="submit"name ="admin-add-resdiance" class=" btn btn-block send-button tx-tfm">Add</button>
